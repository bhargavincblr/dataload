...
public class Education extends SeleneseTestCase {
	...
	public void testEducation() throws Exception {
        ...
        try{
            ...
            for(int i=4;i<data.length;i++){
            	boolean flag = sfr.educationKOL(data[0], data[1], data[2],data[3], data[i]);
                if (!flag)
    				throw new Exception(); 
            }
    		...
    		GenericFuntions.writeSummaryPass("KOL Education");
